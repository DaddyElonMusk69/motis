...
def _run_async(coro):
    ...
    the gateway's async stack), we spin up a
...
try:
    from motis_cli.plugins import discover_plugins
    discover_plugins()
except Exception as e:
...
def handle_function_call(
    ...
    try:
        ...
        try:
            from motis_cli.plugins import invoke_hook
            invoke_hook(
                "pre_tool_call",

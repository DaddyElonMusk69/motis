...
def skills_list(category: str = None, task_id: str = None) -> str:
    ...
    try:
        ...
        if not all_skills:
            ...
            if local_dir_created and external_dirs:
                message = "No skills found in local profile skills. Bundled/external skill directories were scanned too."
            elif local_dir_created:

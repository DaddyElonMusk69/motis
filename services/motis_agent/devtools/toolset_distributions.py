...
Usage:
    from devtools.toolset_distributions import get_distribution, list_distributions
...
DISTRIBUTIONS = {
    ...
    # Vision-focused distribution (kept under the legacy name for compatibility)
    "image_gen": {
        "description": "Heavy focus on vision analysis with web and browser support",
        "toolsets": {
            "vision": 90,
            "browser": 70,
            "web": 55,
    ...
    # Creative analysis (vision + browser)
    "creative": {
        "description": "Vision analysis and browser exploration focus",
        "toolsets": {
            "vision": 90,
            "browser": 60,
            "web": 30
...
if __name__ == "__main__":
    ...
    test_distributions = ["creative", "research", "balanced", "default"]
    ...
    print("-" * 40)
    print_distribution_info("creative")

...
def build_tool_preview(tool_name: str, args: dict, max_len: int | None = None) -> str | None:
    ...
    *max_len* controls truncation.  ``None`` (default) defers to the global
    ...
    if not args:
        return None
    primary_args = {
        "terminal": "command", "web_search": "query", "web_extract": "urls", "read_url": "url", "web_fetch": "url",
        "read_file": "path", "write_file": "path", "patch": "path",
        "search_files": "pattern", "browser_navigate": "url",
        "browser_click": "ref", "browser_type": "text",
        "text_to_speech": "text",
        "vision_analyze": "question", "mixture_of_agents": "user_prompt",
        "skill_view": "name", "skills_list": "category", "load_skill": "name", "list_skills": "category",
        "data.resolve_symbol": "symbol", "data.ohlcv": "symbol", "data.ticker": "symbol",
        "data.orderbook": "symbol", "data.funding_rate": "symbol", "data.open_interest": "symbol",
        "macro.get_series": "series", "equity.get_fundamentals": "symbols",
        "equity.get_earnings_calendar": "symbols", "flows.get_connect": "direction",
        "china.get_moneyflow": "symbols",
        "smc.structure": "symbol", "factor_analysis": "factor_csv",
        "options_pricing": "strike", "pattern": "symbol", "pattern_recognition": "symbol",
        "operator_create": "name", "operator_list": "state_filter", "load_operator": "operator_id",
        "operator_invoke": "operator_id", "operator_status": "operator_id", "operator_pause": "operator_id",
        "operator_archive": "operator_id", "operator_update_prompt": "node_name", "operator_export": "operator_id",
        "cronjob": "action",

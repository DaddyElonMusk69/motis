"""BuiltinMemoryProvider — wraps built-in Motis memory as a MemoryProvider.

Always registered as the first provider. Cannot be disabled or removed.
Structured SQLite rows are the source of truth; MEMORY.md and USER.md remain
compatibility exports for the remaining Hermes-era tooling.
...
class BuiltinMemoryProvider(MemoryProvider):
    """Built-in structured memory with legacy file exports.

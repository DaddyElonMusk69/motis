...
def _tool_name_to_toolset(tool_name: str) -> str | None:
    ...
    aliases = {
        ...
        "web_extract": "web",
        "web_search": "web",
        "data.resolve_symbol": "motis-finance",
        "data.ohlcv": "motis-finance",
        "data.ticker": "motis-finance",
        "data.orderbook": "motis-finance",
        "data.funding_rate": "motis-finance",
        "data.open_interest": "motis-finance",
        "macro.get_series": "motis-finance",
        "equity.get_fundamentals": "motis-finance",
        "equity.get_earnings_calendar": "motis-finance",
        "flows.get_connect": "motis-finance",
        "china.get_moneyflow": "motis-finance",

"""
Cron job scheduling system for Motis.
...
Cron jobs are executed automatically by the gateway daemon:
    motis gateway install    # Install as a user service
    sudo motis gateway install --system  # Linux servers: boot-time system service
    motis gateway            # Or run in foreground

...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="update", description="Update Motis to the latest version")
        ...
        try:
            from motis_cli.commands import discord_skill_commands
    ...
    def _thread_state_path() -> Path:
        ...
        return get_motis_home() / "discord_threads.json"

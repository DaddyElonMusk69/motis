...
from motis_constants import get_hermes_dir as _get_hermes_dir
...
_KEY_EXPORT_PASSPHRASE = "motis-matrix-e2ee-keys"
...
class MatrixAdapter(BasePlatformAdapter):
    ...
    def _thread_state_path() -> Path:
        ...
        from motis_cli.config import get_hermes_home

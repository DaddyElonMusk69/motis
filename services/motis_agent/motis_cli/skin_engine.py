...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Motis"                 # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Motis "        # Response box header label
...
.. code-block:: python
    ...
    from motis_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Motis"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Motis — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Motis",
            "welcome": "Welcome to Motis! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Motis ",
            "prompt_symbol": "❯ ",

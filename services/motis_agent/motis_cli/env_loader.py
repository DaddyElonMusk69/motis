"""Helpers for loading Motis .env files consistently across entrypoints."""
...
def load_motis_dotenv(
    *,
    motis_home: str | os.PathLike | None = None,
...
def load_hermes_dotenv(
    *,
    ...
    return load_motis_dotenv(motis_home=hermes_home, project_env=project_env)

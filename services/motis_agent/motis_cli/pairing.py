...
Usage:
    motis pairing list              # Show all pending + approved users
    motis pairing approve <platform> <code>  # Approve a pairing code
    motis pairing revoke <platform> <user_id> # Revoke user access
    motis pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle motis pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: motis pairing {list|approve|revoke|clear-pending}")
        print("Run 'motis pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'motis pairing list' to see pending codes.\n")

...
into prompt_toolkit's event loop. Each function takes the MotisCLI instance
...
from motis_cli.banner import cprint, _DIM, _RST
from motis_cli.config import save_env_value_secure

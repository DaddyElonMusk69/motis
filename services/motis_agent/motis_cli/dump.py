"""
Dump command for motis CLI.

Outputs a compact, plain-text summary of the user's Motis setup
...
from motis_cli.config import get_motis_home, get_env_path, get_project_root, load_config
...
def run_dump(args):
    ...
    lines.append(f"hermes_home:      {display_motis_home()}")
    ...
    toolsets = config.get("toolsets", ["motis-cli"])
